...
print(str_dict)
print(str_dict[3])  # you'll notice a blank line in the printout, that's because it defaults to a blank string
print("blank value added: ", str_dict)  # it also adds the value to the dict with a blank value
...
str_dict.default_factory = lambda: "I'm not here"  # it does still have to be through a lambda or function call
...
print(dict_lambda, dict_lambda[0], "I am a dict?", isinstance(lambda_dict, dict))  # but default dict is a dict
