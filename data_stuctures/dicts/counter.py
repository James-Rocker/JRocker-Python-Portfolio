...
print(
    Counter(tuple_of_things)
)  # something you may notice is that the count gets sorted in descending order
...
print(
    "the most common objects by x, in this case the 2 most common",
